...
def main() -> None:
    ...
    if args.html:
        ...
        html = fetch_with_browser_or_exit()
        print("Fetched ForexFactory calendar with Playwright")
    else:
        try:
            html = fetch_calendar_html()
            print("Fetched ForexFactory calendar")
    ...
    with SessionLocal() as db:
        result = upsert_events(db, events)
...
def fetch_with_browser_or_exit() -> str:
    try:
        return fetch_calendar_html_with_browser()
